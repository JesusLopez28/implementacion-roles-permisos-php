...
<head>
    ...
    <title>Editar Factura - Empleado</title>
            ...
            <div class="card-body">
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="usuario" value="<?php echo $factura['usuario']; ?>" readonly>
                        <div class="form-text text-muted">Como empleado, no puede cambiar el cliente asociado a la factura.</div>
                    </div>
                    <div class="mb-3">
